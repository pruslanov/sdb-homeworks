...
```
> Добавляем правила обработки логов, создаем файлы с правилами обрботки **/etc/logstash/conf.d** (механизм pipiline). Можно все правила поместить в один файл
...
<img src = "img/w11-03-011.png">

> Cкриншот интерфейса Kibana, логи Nginx, отправленые через Filebeat.

<img src = "img/w11-03-012.png">

<img src = "img/w11-03-013.png">
